...
public interface SedanDataSource {
    ...
    /**
     * Fetch the raw typed value at {@code key} without String conversion.
     * Implementations should override to return the actual stored object.
     * The default delegates to {@link #getStringValue} for backwards compatibility.
     */
    default Object getObjectValue(String key) {
